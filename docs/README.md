...
This pulls `ghcr.io/vano04/runtrace` and `ghcr.io/vano04/runtrace-web`. Both default to the version in `RUNTRACE_VERSION` or `0.1.0` and are published for Linux AMD64.
